...
testCommands config =
    ...
    , Task.attempt (Sign "sign") (Web3.Eth.sign (Address "0xc1675f8bd62c1566627f0b95497871cc43fb2c9a") config.hexData)
    ...
    , Task.attempt (CallAtBlock "callAtBlock") (Web3.Eth.callAtBlock config.blockNumber config.txParams)
